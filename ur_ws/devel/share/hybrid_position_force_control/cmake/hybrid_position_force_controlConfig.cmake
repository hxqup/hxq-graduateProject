...
if(NOT "/home/hxq/ur_ws/src/Compliant-Control-and-Application/Controllers_Algorithms/control_algorithm/hybrid_position_force_control/include " STREQUAL " ")
  set(hybrid_position_force_control_INCLUDE_DIRS "")
  set(_include_dirs "/home/hxq/ur_ws/src/Compliant-Control-and-Application/Controllers_Algorithms/control_algorithm/hybrid_position_force_control/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hybrid_position_force_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hxq/ur_ws/src/Compliant-Control-and-Application/Controllers_Algorithms/control_algorithm/hybrid_position_force_control/${idir}'.  ${_report}")
    endif()
