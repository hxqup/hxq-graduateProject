...
public:
    GravityCompensate()
    {
        ...
        origin_wrench_sub = nh.subscribe("/robotiq_ft_wrench", 1000, &GravityCompensate::WrenchsubCallback,this);
...
void GravityCompensate::WrenchsubCallback(const geometry_msgs::WrenchStamped& msg){
    ...
    tool_pub_msg.wrench.force.y=wrench_tool(1) - 1;
